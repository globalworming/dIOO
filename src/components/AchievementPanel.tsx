          ...
          <div className="flex-1 overflow-y-auto pr-2 space-y-4">
            ...
            {showDebug && (
              <div className="p-2 border border-yellow-500/50 rounded-lg">
                <div className="text-xs text-yellow-500 mb-2">Debug: Links</div>
                <div className="space-y-1">
                  <a
                    href="#/debug/modifiers"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full text-xs p-2 rounded bg-yellow-500/20 hover:bg-yellow-500/40 transition-colors text-center"
                  >
                    Modifier Debug (new window)
                  </a>
                </div>
              </div>
            )}
